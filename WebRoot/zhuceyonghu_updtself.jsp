...
<%
        ...
        , (String)request.getSession().getAttribute("username") , "zhuceyonghu");
...
<form  action="?f=f"  method="post" name="form1" id="form1">
    ...
    <table width="100%" class="table table-insert" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
            ...
            <td width="200">性别：</td>
            <td>
                                                    <select id="xingbie" name="xingbie"   class="class_xingbie2"><option value="男">男</option>
<option value="女">女</option>
</select>
<script>
$(".class_xingbie2").val("<%= Info.html(mmm.get("xingbie")) %>")</script>
                                            </td>
        </tr>
                                        <tr>
            <td width="200">电话：</td>
