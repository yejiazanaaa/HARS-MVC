...
<%
        HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "yisheng");
...
<form  action="?f=f"  method="post" name="form1" id="form1">
    ...
    <table width="100%" class="table table-insert" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
            ...
            <td>
                                                    <select data-rule-required="true" data-msg-required="请填写所属科室" id="suoshukeshi" name="suoshukeshi"   class="class_suoshukeshi20"><% 
...
<script>
$(".class_suoshukeshi20").val("<%= Info.html(mmm.get("suoshukeshi")) %>")</script>
            ...
            <td width="200">性别：</td>
            <td>
                                                    <select id="xingbie" name="xingbie"   class="class_xingbie21"><option value="男">男</option>
<option value="女">女</option>
</select>
<script>
$(".class_xingbie21").val("<%= Info.html(mmm.get("xingbie")) %>")</script>
                                            </td>
        </tr>
                                        <tr>
