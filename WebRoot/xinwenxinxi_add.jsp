...
<%
    ...
    if (request.getParameter("f") != null) {
        ...
        ext.put("neirong", util.DownloadRemoteImage.run(request.getParameter("neirong")));
        String charuid = new CommDAO().insert(request, response, "xinwenxinxi", ext, true, false, "");
...
<form action="?f=f" method="post" name="form1" id="form1">
    ...
    <table width="100%" class="table table-insert" border="1" align="center" cellpadding="3" cellspacing="1"
        ...
        <tr>
            <td width="200">标题：</td>
            <td>
                <input style="width:250px;" data-rule-required="true" data-msg-required="请填写标题"
                       remote="factory/checkno.jsp?checktype=insert&table=xinwenxinxi&col=biaoti"
                       data-msg-remote="内容重复了" id="biaoti" name="biaoti" value="" type="text"/> <span
        ...
        <tr>
            <td width="200">分类：</td>
            <td>
                <select data-rule-required="true" data-msg-required="请填写分类" id="fenlei" name="fenlei"
                        class="class_fenlei4"><%
        ...
        <tr>
            <td width="200">添加人：</td>
            <td>
                <input style="width:150px;" readonly="readonly" id="tianjiaren" name="tianjiaren"
