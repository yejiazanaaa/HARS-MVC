...
String InsertId = new CommDAO().insert(request,response,"pinglun",ext,true,true,"");
if(!InsertId.equals("0") && !InsertId.equals("")){
   %>
<script>alert("评论成功");parent.location.reload()</script>
<% }
}
%>
   ...
   function check()
{
    ...
    <form  action="hsgpinglun.jsp?f=f"  method="post" name="form1">
