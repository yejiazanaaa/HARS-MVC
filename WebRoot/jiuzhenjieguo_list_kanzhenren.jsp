...
<div class="form-search">
    <form name="form1" id="formSearch" method="get" action="">
        所属科室：<select id="suoshukeshi" name="suoshukeshi" class="class_suoshukeshi26">
        ...
        <script>
            $(".class_suoshukeshi26").val("<%= request.getParameter("suoshukeshi") !=null ? request.getParameter("suoshukeshi") : "" %>")</script>
...
<%
    ...
    String where = " 1=1 ";
    where += " AND kanzhenren='" + request.getSession().getAttribute("username") + "' ";
    ...
    <table width="100%" border="1" class="table table-bordered table-hover" align="center" cellpadding="3"
        ...
        <tr>
            ...
            <td align="center">
                ...
                <a href="jiuzhenjieguo_list_kanzhenren.jsp?scid=<%= map.get("id") %>"
