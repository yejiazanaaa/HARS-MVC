...
<body class="withvernav" style="overflow: hidden">
<div class="bodywrapper">
    <div class="topheader">
        <div class="left">
            <h1 class="logo"><span>医院预约挂号系统</span></h1>
        ...
        <div class="right">
            <div class="notification">
                <font color="white">当前用户：<%= request.getSession().getAttribute("username") !=null ? request.getSession().getAttribute("username") : "" %>&nbsp;&nbsp;权限：<%= request.getSession().getAttribute("cx") !=null ? request.getSession().getAttribute("cx") : "" %> </font>
    ...
    <div class="header">
        <ul class="headermenu">
            ...
            <li><a href="logout.jsp" onclick="return confirm('确定要退出?');"><span class="icon icon-message"></span>退出登陆</a>
            </li>
            <li><a href="./" target=""><span class="icon icon-flatscreen"></span>前台首页</a></li>
    ...
    <% } %>
        ...
        <% } %>
            <% if( "医生".equals( request.getSession().getAttribute("cx") ) ){ %>
        <%@ include file="left_yisheng.jsp" %>
        <% } %>
        <!--leftmenu-->

    <div class="centercontent">
        <iframe name="main" src="sy.jsp" runat="server" id="contents"
                style="height:100%; vertical-align: middle; text-align: center;" width="100%" marginheight="5"
