...
Collect<HashMap> list = Query.make("youqinglianjie").where(where).order(orderId+" "+sortId).page(15);
...
<table width="100%" border="1" class="table table-bordered table-hover" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF">
    ...
    <tr>
        ...
        <th bgcolor="#CCFFFF"> 网站名称 </th>
<th bgcolor="#CCFFFF"> 网址 </th>
...
<td> <%= map.get("wangzhi") %> </td>
        ...
        <td align="center">
                                                    <a href="youqinglianjie_updt.jsp?id=<%= map.get("id") %>">修改</a>
            <a href="youqinglianjie_list.jsp?scid=<%= map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a>
                        <!--qiatnalijne-->
        </td>
    </tr>
