...
<div class="form-search">
    <form name="form1" id="formSearch" method="get" action="">
        所属科室：<select id="suoshukeshi" name="suoshukeshi" class="class_suoshukeshi23">
        ...
        <script>
            $(".class_suoshukeshi23").val("<%= request.getParameter("suoshukeshi") !=null ? request.getParameter("suoshukeshi") : "" %>")</script>
    ...
    <table width="100%" border="1" class="table table-bordered table-hover" align="center" cellpadding="3"
        ...
        <tr>
            ...
            <td align="center">
                ...
                <%}%>
                <a href="yuyueguahao_list_yuyueren.jsp?scid=<%= map.get("id") %>"
